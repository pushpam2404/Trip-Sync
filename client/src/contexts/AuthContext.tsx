...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const [profileSetupData, setProfileSetupData] =
    useState<ProfileSetupData | null>(null);
  ...
  const completeProfileSetup = useCallback(
    async (vehicleData: VehicleRegistrationData) => {
      setIsLoading(true);
      try {
        const tempData = JSON.parse(
          localStorage.getItem("tripsync-signup-temp") || "{}",
        );
